...
/**
 * Platform specific configuration options for Native
 * */
public actual class PlatformConfig private constructor(
    public val maxReaderConnections: Int,
) {
    ...
    public actual class Builder internal actual constructor(other: PlatformConfig?) {
        ...
        /**
         * Under the hood, [NativeSqliteDriver] is being utilized which allows
         * setting the number of maximum reader connections for the reader thread
         * pool.
         *
         * This option is **not** utilized for ephemeral databases.
         * */
        public var maxReaderConnections: Int = 1

        init {
            if (other != null) {
                maxReaderConnections = other.maxReaderConnections
            }
        }
    ...
    actual override fun equals(other: Any?): Boolean {
        return  other is PlatformConfig
                && other.maxReaderConnections == maxReaderConnections
    }

    actual override fun hashCode(): Int {
        return 17 * 31 + maxReaderConnections.hashCode()
    }
    ...
    actual override fun toString(): String {
        return buildString {
            ...
            appendLine(": [")
            appendIndent("maxReaderConnections: ")
            appendLine(maxReaderConnections)
            append(']')
        }
    }
}
